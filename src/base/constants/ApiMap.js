...
export const autoCompleteApiMap = {
  ...
  companyCode: GET_ALL_COMPCODE_AUTOCOMPLETE,
  riskClass: GET_ALL_RISKCLASS_AUTOCOMPLETE,
  ...
  garnishmentGroupCode: GET_GARNISMENT_GROUP_CODE_AUTOCOMPLETE,
  ...
  groupCode: GET_GROUP_CODE_AUTOCOMPLETE,
  taxCodeUdq: GET_TAX_CODE_UDQ_AUTOCOMPLETE_MOCKDATA,
  typeOfData: GET_TYPEOF_DATA_AUTOCOMPLETE_MOCKDATA,
  userTax: GET_USER_TAX_AUTOCOMPLETE_MOCKDATA,
  paymentCode: GET_PAYMENT_CODE_AUTOCOMPLETE_MOCKDATA,
  taxCodeOverridden: GET_TAX_CODE_OVERRIDDEN_AUTOCOMPLETE_MOCKDATA,
  formula: GET_FORMULA_AUTOCOMPLETE_MOCKDATA,
